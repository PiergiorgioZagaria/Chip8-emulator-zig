...
pub fn setImguiThemeSolarized(cl: *[c.ImGuiCol_COUNT]c.ImVec4) void {
    // light:
...
pub fn setImguiThemeCyberpunk(cl: *[c.ImGuiCol_COUNT]c.ImVec4) void {
    // https://github.com/imgui-works/ImguiCandy_animations_themes/blob/main/ImCandy/candy.h
    c.igStyleColorsDark(null); //Reset to base/dark theme
    cl[c.ImGuiCol_Text] = c.ImVec4{ .x = 0.00, .y = 0.82, .z = 1.00, .w = 1.00 };
    cl[c.ImGuiCol_TextDisabled] = c.ImVec4{ .x = 0.00, .y = 0.36, .z = 0.63, .w = 1.00 };
    cl[c.ImGuiCol_WindowBg] = c.ImVec4{ .x = 0.00, .y = 0.04, .z = 0.12, .w = 1.00 };
    cl[c.ImGuiCol_ChildBg] = c.ImVec4{ .x = 0.03, .y = 0.04, .z = 0.22, .w = 1.00 };
    cl[c.ImGuiCol_PopupBg] = c.ImVec4{ .x = 0.12, .y = 0.06, .z = 0.27, .w = 1.00 };
    cl[c.ImGuiCol_Border] = c.ImVec4{ .x = 0.61, .y = 0.00, .z = 1.00, .w = 1.00 };
    cl[c.ImGuiCol_FrameBg] = c.ImVec4{ .x = 0.00, .y = 0.75, .z = 1.00, .w = 0.20 };
    cl[c.ImGuiCol_FrameBgHovered] = c.ImVec4{ .x = 0.34, .y = 0.00, .z = 1.00, .w = 1.00 };
    cl[c.ImGuiCol_FrameBgActive] = c.ImVec4{ .x = 0.08, .y = 0.00, .z = 1.00, .w = 1.00 };
    cl[c.ImGuiCol_TitleBg] = c.ImVec4{ .x = 0.00, .y = 0.81, .z = 0.95, .w = 1.00 };
    cl[c.ImGuiCol_TitleBgActive] = c.ImVec4{ .x = 0.61, .y = 0.00, .z = 1.00, .w = 1.00 };
    cl[c.ImGuiCol_TitleBgCollapsed] = c.ImVec4{ .x = 0.25, .y = 0.00, .z = 0.54, .w = 0.81 };
    cl[c.ImGuiCol_MenuBarBg] = c.ImVec4{ .x = 0.61, .y = 0.00, .z = 1.00, .w = 1.00 };
    cl[c.ImGuiCol_ScrollbarBg] = c.ImVec4{ .x = 0.00, .y = 0.88, .z = 1.00, .w = 1.00 };
    cl[c.ImGuiCol_ScrollbarGrab] = c.ImVec4{ .x = 0.61, .y = 0.00, .z = 1.00, .w = 1.00 };
    cl[c.ImGuiCol_ScrollbarGrabHovered] = c.ImVec4{ .x = 0.01, .y = 0.00, .z = 1.00, .w = 1.00 };
    cl[c.ImGuiCol_ScrollbarGrabActive] = c.ImVec4{ .x = 0.95, .y = 0.19, .z = 0.67, .w = 1.00 };
    cl[c.ImGuiCol_CheckMark] = c.ImVec4{ .x = 0.95, .y = 0.19, .z = 0.92, .w = 1.00 };
    cl[c.ImGuiCol_SliderGrab] = c.ImVec4{ .x = 0.00, .y = 1.00, .z = 0.95, .w = 1.00 };
    cl[c.ImGuiCol_SliderGrabActive] = c.ImVec4{ .x = 0.81, .y = 0.00, .z = 1.00, .w = 1.00 };
    cl[c.ImGuiCol_Button] = c.ImVec4{ .x = 0.00, .y = 0.98, .z = 1.00, .w = 0.52 };
    cl[c.ImGuiCol_ButtonHovered] = c.ImVec4{ .x = 0.94, .y = 0.00, .z = 1.00, .w = 0.80 };
    cl[c.ImGuiCol_ButtonActive] = c.ImVec4{ .x = 0.01, .y = 0.00, .z = 1.00, .w = 1.00 };
    cl[c.ImGuiCol_Header] = c.ImVec4{ .x = 0.00, .y = 0.95, .z = 1.00, .w = 0.40 };
    cl[c.ImGuiCol_HeaderHovered] = c.ImVec4{ .x = 0.94, .y = 0.00, .z = 1.00, .w = 0.80 };
    cl[c.ImGuiCol_HeaderActive] = c.ImVec4{ .x = 0.01, .y = 0.00, .z = 1.00, .w = 1.00 };
    cl[c.ImGuiCol_Separator] = c.ImVec4{ .x = 0.74, .y = 0.00, .z = 1.00, .w = 0.50 };
    cl[c.ImGuiCol_SeparatorHovered] = c.ImVec4{ .x = 0.34, .y = 0.00, .z = 1.00, .w = 0.78 };
    cl[c.ImGuiCol_SeparatorActive] = c.ImVec4{ .x = 0.00, .y = 1.00, .z = 0.85, .w = 1.00 };
    cl[c.ImGuiCol_ResizeGrip] = c.ImVec4{ .x = 0.61, .y = 0.00, .z = 1.00, .w = 1.00 };
    cl[c.ImGuiCol_ResizeGripHovered] = c.ImVec4{ .x = 0.89, .y = 0.26, .z = 0.98, .w = 0.67 };
    cl[c.ImGuiCol_ResizeGripActive] = c.ImVec4{ .x = 0.00, .y = 0.88, .z = 1.00, .w = 0.95 };
    cl[c.ImGuiCol_Tab] = c.ImVec4{ .x = 0.36, .y = 0.00, .z = 1.00, .w = 1.00 };
    cl[c.ImGuiCol_TabHovered] = c.ImVec4{ .x = 0.00, .y = 0.92, .z = 1.00, .w = 0.80 };
    cl[c.ImGuiCol_TabActive] = c.ImVec4{ .x = 0.62, .y = 0.00, .z = 0.80, .w = 1.00 };
    cl[c.ImGuiCol_PlotHistogram] = c.ImVec4{ .x = 0.00, .y = 1.00, .z = 0.88, .w = 1.00 };
}
